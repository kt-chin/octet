...
#####Youtube Link: https://youtu.be/gyruiInjVRU
...
Which moves the player left and right. In the move forward function, we set the movement speed to negative of the value in order to prevent the player from going through the walls.
